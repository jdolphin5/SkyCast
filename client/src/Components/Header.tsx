...
const Header: React.FC = () => {
  ...
  const layoutStyle = {
    height: showHideMainMenu ? "400px" : "60px",
  };
    ...
    <div style={layoutStyle}>
      ...
      >
        <div className="grid-wrapper-header">
          <div style={{ padding: "5px 10px 5px 10px", fontSize: "20px" }}>
            ...
            >
              ...
              >
                ...
                {showHideMainMenu && (
                  <div
                    style={{ padding: "0px 0px 0px 0px", textAlign: "right" }}
                  >
                    X
                  </div>
                )}
          ...
          <div
            style={{ backgroundColor: "#FFFFFF", padding: "5px 0px 5px 0px" }}
          >
              ...
              <Dropdown>
                ...
                >
                  <MenuItem
                    ...
                    onClick={createHandleMenuClick("OpenWeatherMap")}
                  >
                    OpenWeatherMap
                  </MenuItem>
                  <MenuItem
                    className="CustomMenuIntroduction--item"
                    onClick={createHandleMenuClick("VisualCrossing")}
                  >
                    VisualCrossing
                  </MenuItem>
                </Menu>
